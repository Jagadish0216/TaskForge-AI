...
import { Folder, Archive, RotateCcw, Trash2, Edit, Users, ArrowRight } from 'lucide-react';
        ...
        <div className="space-y-1 mb-4">
          <div className="flex justify-between text-[11px] font-mono font-bold text-slate-500">
            ...
            <span className="text-blue-500">
              {totalTasks > 0 ? `${completedTasks}/${totalTasks} (${progressPct}%)` : 'No tasks yet'}
            </span>
          </div>
          ...
          <div className="flex items-center gap-1 opacity-90 group-hover:opacity-100 transition-opacity">
            {onEdit && (
              <button
                ...
                title="Edit Project"
                className="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer"
              >
            ...
            {project.archived ? (
              onRestore && (
                <button
                  ...
                  className="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors cursor-pointer"
                >
              ...
              onArchive && (
                <button
                  ...
                  className="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-slate-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors cursor-pointer"
                >
            ...
            {onDelete && (
              <button
                ...
                className="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-slate-400 hover:text-red-600 dark:hover:text-red-400 transition-colors cursor-pointer"
              >
            ...
            <button
              ...
              onClick={() => navigate(`/projects/${project.id}`)}
              title="Open Details"
              className="p-1.5 hover:bg-blue-50 dark:hover:bg-blue-950/50 rounded-lg text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer"
            >
